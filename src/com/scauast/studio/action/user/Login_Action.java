...
import com.scauast.studio.service.user.Factory.CheckingUser_Factory;
...
public class Login_Action extends ActionSupport implements SessionAware {
	...
	private User_Service_Factory USEF = new CheckingUser_Factory();
	@Override
	public String execute() throws Exception {
		User_Service US = USEF.createUser_Service();
		userid = (int) US.ExecuteService(this);
