...
public class Function_Library {
	...
	public static final Cookie NewCookie(String name, String value) {//设置cookie
	...
	public final static Cookie findCookie(Cookie[] cookies,String name) {  //查找所需cookie，不存在返回null。 Coder：xillkey
		Cookie result=null;
